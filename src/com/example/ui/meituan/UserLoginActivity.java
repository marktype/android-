		...
		mLoginBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mUserName.getText().toString().equals("a")&& 
					...
					startActivity(new Intent(UserLoginActivity.this, ViewPagerAdapter.class));
					finish();
				}else{
					new AlertDialog.Builder(UserLoginActivity.this).setTitle("提示信息").setMessage("输入错误，请填写正确的用户和密码！").
